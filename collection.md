...
|Method	|Paper Title	|Conference/Journal|Year|
|------ |------|--------|--------|
|Infmix	|Influence-Driven Data Poisoning for Robust Recommender Systems|	TPAMI|	2023|
|FedAttack	|FedAttack: Effective and covert poisoning attack on federated recommendation via hard sampling|	SIGKDD	|2022|
|ClusterAttack	|Untargeted attack against federated recommendation systems via poisonous item embeddings and the defense	|AAAI	|2023|
|UA-FedRec	|UA-FedRec: untargeted attack on federated news recommendation|	SIGKDD|	2023|


<h2> A summary of the surveyed papers on Targeted Manipulation Attacks</h2>
...
<h2> A summary of the surveyed papers on Hybrid-Goal Attacks</h2>

|Method	|Paper Title	|Conference/Journal|Year|
|------ |------|--------|--------|
|SGLD	|Data poisoning attacks on factorization-based collaborative filtering	|NIPS	|2016|
...
|Method	|Paper Title	|Conference/Journal|Year|
|------ |------|--------|--------|
|SUI-Attack|	Single-User Injection for Invisible Shilling Attack against Recommender Systems|	CIKM	|2023|
|ModelExtractionAttack|	Black-box attacks on sequential recommenders via data-free model extraction	|RecSys	|2021|
|CopyAttack|	Attacking black-box recommendations via copying cross-domain user profiles	|ICDE	|2021|
|PC-Attack|	Practical Cross-system Shilling Attacks with Limited Access to Data	|AAAI|	2023|
|LOKI|	Practical data poisoning attack against next-item recommendation|	WWW	|2020|
|KG-Rlattack	|Poisoning attacks against knowledge graph-based recommendation systems using deep reinforcement learning	|Neural Computing and Applications|	2022|


<h2> A summary of the surveyed papers on Invisibility-Assured Probing Attacks</h2>

|Method	|Paper Title	|Conference/Journal|Year|
|------ |------|--------|--------|
|AdvAttack	|Adversarial attacks on an oblivious recommender|	RecSys|	2019|
|AUSH|	Revisiting adversarially learned injection attacks against recommender systems	|RecSys|	2020|
|LegUP	|Shilling Black-Box Recommender Systems by Learning to Generate Fake User Profiles	|TNNLS	|2022|
|GOAT	|Ready for emerging threats to recommender systems? A graph convolution-based generative shilling attack|	Information Sciences|	2021|
|GSPAttack	|Poisoning GNN-based recommender systems with generative surrogate-based attacks|	ACM TOIS|	2022|
|TrialAttack	|Triple adversarial learning for influence based poisoning attack in recommender systems	|CIKM	|2021|
|PipAttack|	Black-box attacks on sequential recommenders via data-free model extraction|RecSys	|2021|
|FedRecAttack|	FedRecAttack: model poisoning attack to federated recommendation|	ICDE	|2022|
|RecUP	|Attacking recommender systems with plausible profile	|IEEE TIFS|	2022|
|GSA-GANs	|Gray-box shilling attack: an adversarial learning approach	|ACM TIST	|2022|
